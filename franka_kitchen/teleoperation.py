...
if __name__ == "__main__":
    ...
    env = gym.make(env_name, max_episode_steps=max_episode_steps, tasks_to_complete=[task], autoreset=False)
        ...
        while not done and episode_steps < max_episode_steps:
            ...
            if action is not None:
                ...
                print(f"Episode step: {episode_steps} Reward: {reward} Successfully added "
                    f"{memory.mem_ctr - starting_memory_size} steps to memory. Total: {memory.mem_ctr}")
